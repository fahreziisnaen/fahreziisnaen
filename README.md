...
### IT Infrastructure for Phillip Securities Hong Kong Region at [PT. CyberQuote Indonesia.]
- Managed and maintained data center network infrastructure for the Hong Kong region.
- Monitored network health and responded to alerts to maintain uptime and reliability.
- Diagnosed and resolved connectivity and performance issues across WAN/LAN environments.
- Administered FortiGate firewalls, including security policies, NAT, and IPSec VPN connectivity.
- Managed leased-line and WAN links, coordinating with carriers to resolve circuit issues.
- Conducted regular network audits and maintained network documentation.
## 🛠 Technical Skills
### Networking
